...
class XingTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGettingUserDetails()
    {
        ...
        $me = $this;
        $client->shouldReceive('get')->with('https://api.xing.com/v1/usersData/me', m::on(function ($options) use ($me) {
            $headers = $options['headers'];
    ...
    private function getUserPayload()
    {
		...
		"usersData":[
			...
			"photo_urls":
				{
				"large":"https://x1.xingassets.com/assets/frontend_minified/img/usersData/nobody_m.140x185.jpg",
				"maxi_thumb":"https://x1.xingassets.com/assets/frontend_minified/img/usersData/nobody_m.70x93.jpg",
				"medium_thumb":"https://x1.xingassets.com/assets/frontend_minified/img/usersData/nobody_m.57x75.jpg"
				},

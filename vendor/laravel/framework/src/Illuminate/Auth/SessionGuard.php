...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function attempt(array $credentials = [], $remember = false, $login = true)
    {
        ...
        // fact valid we'll log the usersData into the application and return true.
    ...
    public function login(AuthenticatableContract $user, $remember = false)
    {
        ...
        // identifier. We will then decrypt this later to retrieve the usersData.
        if ($remember) {
    ...
    public function logout()
    {
        ...
        // Once we have fired the logout event we will clear the usersData out of memory

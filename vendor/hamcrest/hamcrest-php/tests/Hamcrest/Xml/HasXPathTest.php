...
HTML;
    ...
    {
        return \Hamcrest\Xml\HasXPath::hasXPath('/usersData/user');
    }
    ...
    public function testHasAReadableDescription()
    {
        $this->assertDescription(
            'XML or HTML document with XPath "/usersData/user"',
            hasXPath('/usersData/user')
        );
        $this->assertDescription(
            'XML or HTML document with XPath "count(/usersData/user)" <2>',
            hasXPath('/usersData/user', 2)
        );
        $this->assertDescription(
            'XML or HTML document with XPath "/usersData/user/name"'
            . ' a string starting with "Alice"',
            hasXPath('/usersData/user/name', startsWith('Alice'))
        );
    }
    ...
    public function testHasAReadableMismatchDescription()
    {
        ...
        $this->assertMismatchDescription(
            ...
            hasXPath('/usersData/user/id', 'Frank'),
            self::$doc
        );
    }
}
